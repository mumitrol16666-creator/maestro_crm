...
const OFFICIAL_TARIFFS = [
    ...
    { type: 'individual_1_2', label: 'Индив 1-2', price: 32000, classes: 8, days: 30, lessonFormat: 'individual', durationMinutes: 60 },
    { type: 'individual_2_2', label: 'Индив 2-2', price: 60000, classes: 16, days: 60, lessonFormat: 'individual', durationMinutes: 60 },
