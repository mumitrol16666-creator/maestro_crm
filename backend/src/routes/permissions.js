...
function getDefaultPermissions(role) {
    const defaults = {
        super_admin: {
            ...
            visibility: { dashboard: true, bookings: true, students: true, membership_actions: true, groups: true, schedule: true, directions: true, users: true, roles: true, activity_logs: true }
        },
        admin: {
            ...
            visibility: { dashboard: true, bookings: true, students: true, membership_actions: true, groups: true, schedule: true, users: true, activity_logs: true }
        },
        sales_manager: {
            permissions: { canManageBookings: true, canManageStudents: true, canManagePayments: true },
            visibility: { bookings: true, students: true, membership_actions: true, groups: true, schedule: true }
        },
        teacher: {
