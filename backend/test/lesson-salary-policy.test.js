...
test('экстренная заморозка не оплачивается преподавателю', () => {
    const lesson = {
        classType: 'individual',
        status: 'completed',
...
test('групповой урок оплачивается, если другой ученик присутствовал при заморозке', () => {
    const lesson = {
        classType: 'group',
        status: 'completed',
        attendees: [
            { attendanceStatus: 'emergency_freeze' },
