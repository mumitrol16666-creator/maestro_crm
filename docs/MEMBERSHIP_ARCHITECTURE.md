...
> Исторический проект модели. С 23.09.2026 действуют [бессрочные расценки ученика](./STUDENT_RATE_CARDS.md). Описанные ниже лимиты, сроки и резервные цены не применяются к новым тарифам.
