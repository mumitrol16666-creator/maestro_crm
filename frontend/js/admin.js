...
// ==================== NAVIGATION ====================
// ✅ Навигация вынесена в modules/core/navigation.js
// Вызывается через initNavigation() в DOMContentLoaded
...
// ✅ loadSectionData, refreshCurrentSection, invalidateCache теперь в modules/core/sections.js
...
// ✅ applySidebarVisibility, initUserManagement, displayCurrentUser теперь в modules/core/sidebar.js
...
window.addEventListener('DOMContentLoaded', async () => {
    // Инициализация навигации (переключение вкладок, sidebar toggle, logout)
    initNavigation();
